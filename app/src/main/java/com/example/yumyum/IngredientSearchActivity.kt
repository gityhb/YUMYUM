...
class IngredientSearchActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (name != null && ingredient != null && time != null && utensil !=null && step !=null) {
            ...
            val newItem = RecipeItem(number, name, ingredient, time, utensil, step, recipeimg, levelimg)
