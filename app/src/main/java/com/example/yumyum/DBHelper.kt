...
class DBHelper(context: Context) : SQLiteOpenHelper(context, DB_NAME, null, DB_VERSION) {
    ...
    /* fun generateRecipeList(): List<Recipe> {
         return listOf(
             ...
             Recipe("닭발", "한식", "무뼈닭발 500g, 통후추 2스푼, 생강 1톨, 고추장 3스푼, 고춧가루 2스푼, 간장 3스푼, 올리고당 1스푼, 다진 마늘 2스푼, 식용유,  ", "프라이팬, 주걱, 냄비, 칼", "", "", 2, 43, "닭발을 해동시켜 깨끗이 씻는다.", "닭발이 잠길 정도로 물을 넣고 통후추 2스푼과 생강 1톨과 함께 10분정도 삶는다.", "삶은 닭발을 찬물에 깨끗이 씻는다.", "닭발에 고추장 3스푼과 고춧가루 2스푼, 간장 2스푼, 올리고당 1스푼을 넣고 버무린다.",
                 "30분동안 재워둔다. ", "달구워진 팬에 식용유를 두르고 재워둔 닭발을 넣고 볶는다.","약한 불에 10분정도 조려준다.","","","","","",0,600,0,0,1800, 0,600,0,0,0,0,0,"","","","","","","","","","","",
                 ""),
             Recipe("머핀", "제과","박력분 340g, 설탕 340g, 바닐라파우더 4g, 계란 4개, 버터 340g, 베이킹파우더 4g, 소금 4g", "믹싱볼, 체, 거품기, 제과제빵용 주걱, 짤주머니, 틀", "","",1, 56,
                 "계란을 풀어 반죽을 준비한다.", "버터에 설탕을 여러번 나누어 넣으면서 녹인다.", "설탕과 버터를 잘 섞었다면 풀어둔 계란을 세번을 나눠 넣어 섞어준다.", "박력분과 베이킹파우더, 바닐라파우더, 소금을 체에 내려준다.","오븐을 170도-180도에서 예열해준다.", "짤주머니에 주걱으로 잘 넣어서 매듭을 집게로 집어준 후 틀에 반죽을 넣어주고 위에 토핑을 넣어준다.","170도에서 20분 구워준다.",
                 "","", "","", "",0,0,0, 0,0,0,1200,0,0,0,0,0,"","","","","","","","","","","",""),
             Recipe("라멘", "일식", "라멘 생면 1인분, 마늘 1/2t, 생강 1/2t, 설탕, 1t, 참기름 1t, 미소, 1T, 돼지고기 150g, 삷은 계랸 1개, 두반장", "프라이팬, 냄비, 주걱, 집게", "","",1,23,"생강을 다진다.", "대파는 채썰어서 찬물에 담가둔다.", "숙주를 씻어서 물기를 빼놓는다.",
